...
Concretely: the publication pipeline is ours — what it verifies before writing an artifact, and its refusal to leave a partial artifact tree behind. The `did:webs` method itself is a [ToIP specification](https://github.com/trustoverip/kswg-did-method-webs-specification); report a flaw in the method there.
